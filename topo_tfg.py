...
def topology():
    ...
    info("*** Creating nodes\n")
    sta1 = net.addStation('sta1', mac='00:00:00:00:00:11', IP='10.0.0.11/8', position='1,1,0')
    sta2 = net.addStation('sta2', wlans=2, mac='00:00:00:00:00:12', IP='10.0.0.12/8', position='31,11,0')
    sta3 = net.addStation('sta3', mac='00:00:00:00:00:13', IP='10.0.0.13/8', position='35,15,0')
    ...
    net.addLink(sta2, channel=10, cls=ITSLink)
    net.addLink(sta3, channel=10, cls=ITSLink)
    ...
    net.plotGraph(max_x=40, max_y=20)
