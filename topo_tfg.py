...
def topology():
    ...
    sta2 = net.addStation('sta2', wlans=2, mac='00:00:00:00:00:02', IP='10.0.0.2/8', position='20,80,0')
    sta3 = net.addStation('sta3', mac='00:00:00:00:00:03', IP='10.0.0.3/8', position='30,80,0')
    ap1 = net.addAccessPoint('ap1', wlans=4, ssid='ssid1,,,', position='20,100,0')
    ...
    ap3 = net.addAccessPoint('ap3', wlans=3, ssid='ssid3,,', position='32,50,0')
    ...
    # net.addLink(ap1, intf='ap1-wlan4', cls=mesh, ssid='mesh-ssid', channel=5)
