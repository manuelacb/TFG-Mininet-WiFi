...
def topology(stp):
    ...
    if stp:
        ...
        ap7 = net.addAccessPoint('ap7', ssid='new-ssid7', mode='g', channel='1',
                                 failMode="standalone", position='100,50,0')
    ap2 = net.addAccessPoint('ap2', wlans=3, ssid='ssid2,,', position='120,100,0', channel='1')
    ...
    ap3 = net.addAccessPoint('ap3', wlans=3, ssid='ssid3,,', position='30,50,0', channel='11')
    ...
    net.addLink(ap8, ap3)
    net.addLink(sta8, ap8)
    net.addLink(ap3, ap9)
    net.addLink(sta9, ap9)
    net.addLink(sta10, ap10)
    net.addLink(sta11, ap11)
    net.addLink(ap10, ap9)
